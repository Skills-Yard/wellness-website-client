...
export default function WallPanel() {
    return (
        <section className="w-full py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto font-sans">
            <div className="relative overflow-hidden rounded-[32px] bg-[#FEF9C3] flex flex-col md:flex-row items-center justify-between p-6 sm:p-8 md:p-10 gap-8 min-h-[350px]">
