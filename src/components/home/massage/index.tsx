                        ...
                        return (
                            <SwiperSlide key={item.id} className="h-auto ">
                                ...
                                >
                                    ...
                                    <div className="relative max-sm:max-h-22 aspect-square max w-full rounded-sm sm:rounded-2xl overflow-hidden bg-stone-100 mb-2 sm:mb-3 md:mb-4">
                                        <Image
                                            src={item.image}
                                            alt={item.title}
                                ...
                                <div className="flex items-center justify-between gap-2 mt-1 sm:mt-3 md:mt-3.5 flex-wrap">
