...
import { WELLNESS_SERVICES } from "@/src/utils/data";
                                ...
                                >
                                    <div>
                                        ...
                                        <div className="space-y-1 relative sm:space-y-1.5">
                                            <h3 className="text-[12px] max-sm:line-clamp-1 sm:text-[13px] md:text-sm lg:text-base font-semibold text-gray-900 line-clamp-2 leading-snug tracking-tight group-hover:text-emerald-600 transition-colors">
                                                {item.title}
                                            </h3>
